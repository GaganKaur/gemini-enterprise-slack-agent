# Performance & Latency Benchmarking Testing Report: Gemini Enterprise UAT Ingestion
...
## 1. Executive Summary
This performance benchmarking testing evaluates latency metrics comparing the **`streamAssist` REST API** (via intent classifier bypass routing) against the **Web App UI Preview Chat** inside the Vertex AI Search & Conversation console. 
...
The benchmarking testing was executed programmatically inside a headless Chromium session connecting over CDP to the active corporate profile:
...
| **Q2** | Confluence | 1 | "how do I configure my corporate VPN on Linux?" |
...
## 7. Benchmarking Testing Artifacts & References
